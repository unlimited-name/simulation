...
if __name__ == '__main__':
    ...
    pymesh.meshio.save_mesh('oj_ref.stl',clean(oj_ref()))
    pymesh.meshio.save_mesh('ij_ref.stl',clean(ij_ref()))
    pymesh.meshio.save_mesh('oj_out.stl',clean(oj_out()))
    pymesh.meshio.save_mesh('ij_out.stl',clean(ij_out()))
    pymesh.meshio.save_mesh('oj_in.stl',clean(oj_in()))
    pymesh.meshio.save_mesh('ij_in.stl',clean(ij_in()))
